  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 flex flex-col">
      ...
      <main id="content" className="flex-grow">
        ...
        {/* Weitere Sektionen wie in der Original TSX-Datei */}
        {/* Gallery Grid */}
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow bg-white">
                <img src="/images/Kunst/impression5.jpeg" alt="Theaterszene" className="w-full h-64 object-cover" />
              </div>
              <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow bg-white">
                <img src="/images/Kunst/impression4.jpeg" alt="Theaterszene" className="w-full h-64 object-cover" />
              </div>
              <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow bg-white">
                <img src="/images/Kunst/impression3.jpeg" alt="Theaterszene" className="w-full h-64 object-cover" />
              </div>
            </div>
          </div>
        </section>
