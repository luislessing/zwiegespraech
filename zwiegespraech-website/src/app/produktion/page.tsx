...
export default function ArchivPage() {
  const pastProductions = [
    {
      id: 1,
      title: "Produktionstitel 1",
      year: "2023",
      image: "/images/production-1.jpg", // Placeholder
      description: "Beschreibung der Produktion"
    },
    {
      id: 2,
      title: "Produktionstitel 2",
      year: "2022",
      image: "/images/production-2.jpg", // Placeholder
      description: "Beschreibung der Produktion"
    },
    {
      id: 3,
      title: "Produktionstitel 3",
      year: "2021",
      image: "/images/production-3.jpg", // Placeholder
      description: "Beschreibung der Produktion"
    },
    {
      id: 4,
      title: "Produktionstitel 4", 
      year: "2020",
      image: "/images/production-4.jpg", // Placeholder
      description: "Beschreibung der Produktion"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {pastProductions.map((production) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <p className="text-sm text-gray-500 mb-2">{production.year}</p>
                    <h3 className="text-xl font-bold mb-2">{production.title}</h3>
                    <p className="text-gray-600">{production.description}</p>
                    <a 
                      href="#" 
          ...
          <div className="container mx-auto px-4">
            <div className="overflow-hidden">
              <div className="whitespace-nowrap animate-marquee">
                +++ Weitere Aufführungstermine folgen in Kürze +++ Weitere Aufführungstermine folgen in Kürze +++ Weitere Aufführungstermine folgen in Kürze +++
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              ...
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div key={i} className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow">
                  <img 
                    src={`/images/archive-${i}.jpg`} // Placeholder images
                    alt={`Theatereindruck ${i}`} 
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg mb-6">
                ...
                Interesse an Aufführungsrechten haben, nehmen Sie gerne{' '}
                <a href="/kontakt" className="text-gray-600 hover:underline">Kontakt</a> mit uns auf.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-100">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Besuche unsere aktuelle Produktion oder nimm Kontakt mit uns auf, wenn du mehr über vergangene Stücke erfahren möchtest.
            </p>
      ...
      {/* Note: Animation styles moved to global CSS */}
    </div>
  );
}